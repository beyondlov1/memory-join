...
public class Main {
    public static void main(String[] args) {
        ...
        computer1.setStudentId("1");
        computer1.setComputerName("computerName1");
        computers.add(computer1);
        Computer computer2 = new Computer();
        computer2.setStudentId("2");
        computer2.setComputerName("computerName2");
        computers.add(computer1);
        Computer computer3 = new Computer();
        computer3.setStudentId("3");
        computer3.setComputerName("computerName3");
        ...
        JoinUtils.JoinResultChain joinResultChain = JoinUtils.start(schools, School.class)
                ...
                // .one2OneJoin(computers, Computer.class, Student::getStudentId, Computer::getStudentId)  // not allowed
                .end();
        ...
        Map<Student, Computer> student2ComputerMap = joinResultChain.getOne2OneMap(Student.class, Computer.class);
        System.out.println(student2ComputerMap);
